...
Campground.create(
    {name: "Salmon Creek", 
     image: "https://images.unsplash.com/photo-1504280390367-361c6d9f38f4?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1400&q=60"}, function(err, campground){
        if(err) {
            console.log(err);
        } else {
